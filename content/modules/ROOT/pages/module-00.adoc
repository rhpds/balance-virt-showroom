...
+
image::exercise0/10_VM_Imported_Project.png[link=self, window=blank, width=100%]
...
+
image::exercise0/19_VM_Configuration.png[link=self, window=blank, width=100%]
+
