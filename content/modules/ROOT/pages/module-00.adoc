...
+
image::exercise0/00_Welcome_Message.png[link=self, window=blank, width=100%]
...
+
image::exercise0/01_Create_Project.png[link=self, window=blank, width=100%]
...
+
image::exercise0/02_Create_Project_Name.png[link=self, window=blank, width=100%]
...
image::exercise0/03_Switch_Virt_View.png[link=self, window=blank, width=100%]
...
image::exercise0/04_Virt_Welcome.png[link=self, window=blank, width=100%]
...
image::exercise0/05_Virt_Overview.png[link=self, window=blank, width=100%]
...
+
image::exercise0/06_Tree_View.png[link=self, window=blank, width=100%]
...
+
image::exercise0/07_Left_Menu.png[link=self, window=blank, width=100%]
...
+
image::exercise0/08_Project_Tree.png[link=self, window=blank, width=100%]
...
+
image::exercise0/09_VM_List.png[link=self, window=blank, width=100%]
...
+
image::exercise0/10_Affinity_Project.png[link=self, window=blank, width=100%]
...
+
image::exercise0/11_VMs_Affinity.png[link=self, window=blank, width=100%]
...
+
image::exercise0/12_Create_VM_Button.png[link=self, window=blank, width=100%]
+
...
+
image::exercise0/13_Create_VM_Templates.png[link=self, window=blank, width=100%]

. Select the *Fedora VM* tile, and a dialog opens.
+
image::exercise0/14_Create_VM_Quick.png[link=self, window=blank, width=100%]

. Change the name to *my-vm* and press *Quick create VirtualMachine*.
+
image::exercise0/15_Create_VM_Quick_Name.png[link=self, window=blank, width=100%]
...
+
image::exercise0/16_Fedora_Running.png[link=self, window=blank, width=100%]
...
+
image::exercise0/17_Fedora_Details.png[link=self, window=blank, width=100%]
...
+
image::exercise0/18_Fedora_Events.png[link=self, window=blank, width=100%]
+
...
+
image::exercise0/20_Configuration_Tab.png[link=self, window=blank, width=100%]
+
...
+
image::exercise0/21_Storage_Tab.png[link=self, window=blank, width=100%]
+
...
+
image::exercise0/22_Network_Tab.png[link=self, window=blank, width=100%]
+
...
+
image::exercise0/23_VM_State_Actions.png[link=self, window=blank, width=100%]
+
...
+
image::exercise0/24_VM_Actions_Menu.png[link=self, window=blank, width=100%]

. Press the *Stop* button and wait until the Virtual Machine is in state *Stopped*.
+
image::exercise0/25_VM_Stopped.png[link=self, window=blank, width=100%]

. Clicking on *Actions* and *Control*, the option *Start* appears, and the options *Restart* and *Pause* are greyed out.
+
image::exercise0/26_VM_Actions_List_Stopped.png[link=self, window=blank, width=100%]
...
+
image::exercise0/27_VM_Actions_Paused.png[link=self, window=blank, width=100%]
