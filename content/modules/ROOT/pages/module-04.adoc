...
. Select the node-affinity namespace, and start the *node-affinity-vm* Virtual Machine that you find there.
...
By ensuring that Affinity and Anti-Affinity rules are set appropriately for your cluster nodes and workloads you can help ensure that there is no single point of failure within your cluster for your virtual machines or other applications.
