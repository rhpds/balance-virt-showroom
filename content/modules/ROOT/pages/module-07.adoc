...
[[NOTE]] This portion of the lab introduces a new feature that just became GA in OpenShift 4.21. As such, the UI-based workflow is not fully developed and should improve dramatically in upcoming OpenShift releases. During this lab we will introduce you to the UI workflow, but perform the migration tasks through the CLI.
