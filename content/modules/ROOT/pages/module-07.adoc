...
In this module we explored decentrailized live migration within a cluster, across namespaces. This is the basic technology that allows us to live migrate workloads between remote clusters, and helps set us up for the future of a true hybrid multicloud environment.
